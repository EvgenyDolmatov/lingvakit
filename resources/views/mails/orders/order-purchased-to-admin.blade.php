    ...
    <tr>
        <td class="o_bg-white o_px-md o_pt" align="center"
            ...
            <p class="o_heading o_text-dark"
               style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 14px;line-height: 31px;">Студент: {{$order->user->getFullName()}}</p>
            <p class="o_heading o_text-dark"
               style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 14px;line-height: 31px;">E-mail: {{$order->user->email}}</p>
            <p class="o_heading o_text-dark"
