    ...
    <tr>
        <td class="o_re o_bg-white o_px o_pt" align="center"
            ...
            <table cellspacing="0" cellpadding="0" border="0" role="presentation">
                <tbody>
                <tr>
                    <td width="200" align="center" valign="top" style="padding: 0px 8px;"><![endif]-->
            ...
            <div class="o_col o_col-4" style="display: inline-block;vertical-align: top;width: 100%;max-width: 400px;">
                ...
                <div class="o_px-xs o_sans o_text o_text-light o_left o_xs-center"
                    ...
                    <h4 class="o_heading o_text-dark o_mb-xxs"
                        ...
                        {{$course->title}}</h4>
                    <p class="o_text-xs o_mb"
                       style="font-size: 14px;line-height: 21px;margin-top: 0px;margin-bottom: 16px;">
                        Уровень: {{__("cms-pages.".$course->difficulty_level)}}<br>
            ...
            <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                ...
                <tr>
                    <td width="300" class="o_btn o_bg-success o_br o_heading o_text" align="center"
                        ...
                        <a class="o_text-white" href="{{route('site.course-show', $course->id)}}"
                           style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Перейти
                            к изучению курса</a>
                    </td>
                </tr>
                </tbody>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
    ...
    <tr>
        <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md" align="center"
            style="background-color: #ebf5fa;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
            <!--[if mso]>
