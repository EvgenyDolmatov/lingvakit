    ...
    <tr>
        <td class="o_bg-white o_px-md o_pt" align="center"
            ...
            <h3 class="o_heading o_text-dark"
                style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 24px;line-height: 31px;">Сброс пароля</h3>
        </td>
    </tr>
    </tbody>
</table>
    ...
    <tr>
        <td class="o_bg-white o_px-md o_pt" align="center"
            ...
            <p class="o_heading o_text-dark"
                style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 14px;line-height: 31px;">
                Для того чтобы сбросить пароль, нажмите на кнопку ниже. Если это были не Вы, то просто проигнорируйте это письмо.
            </p>
        </td>
    </tr>
    </tbody>
                ...
                <tr>
                    <td width="300" class="o_btn o_bg-success o_br o_heading o_text" align="center"
                        ...
                        <a class="o_text-white" href="{{$url}}"
                           style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Сбросить пароль</a>
                    </td>
                </tr>
                </tbody>
            </table>
