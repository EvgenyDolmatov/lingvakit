    ...
    <tr>
        <td class="o_bg-white o_px-md o_pt" align="center"
            ...
            <h3 class="o_heading o_text-dark"
                style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 24px;line-height: 31px;">{{$user->name}}, спасибо за регистрацию на нашем сайте!</h3>
        </td>
    </tr>
    </tbody>
</table>
    ...
    <tr>
        <td class="o_bg-white o_px-md o_pt" align="center"
            ...
            <p class="o_heading o_text-dark"
               style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 14px;line-height: 31px;">Пожалуйста, подтвердите Ваш E-mail адрес, нажав на кнопку ниже:</p>
        </td>
    </tr>
    </tbody>
</table>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
    ...
    <tr>
        <td class="o_bg-white o_px-md o_py-xs" align="center"
            style="background-color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 30px;padding-bottom: 30px;">
                ...
                <tr>
                    <td width="300" class="o_btn o_bg-success o_br o_heading o_text" align="center"
                        ...
                        <a class="o_text-white" href="{{$url}}"
                           style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Подтвердить E-mail</a>
                    </td>
                </tr>
                </tbody>
            </table>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
    ...
    <tr>
        <td class="o_bg-white o_px-md o_pt" align="center"
            style="background-color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 16px;">
            <p class="o_heading o_text-dark"
               style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 14px;line-height: 31px;">Если кнопка подтверждения E-mail не работает, пожалуйста перейдите по этой ссылке:</p>
        </td>
    </tr>
    </tbody>
</table>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
    ...
    <tr>
        <td class="o_bg-white o_px-md o_pt" align="center"
            style="background-color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 16px;">
            <a href="{{$url}}" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 14px;line-height: 31px;">{{$url}}</a>
        </td>
    </tr>
    </tbody>
</table>
    ...
    <tr>
        <td class="o_bg-dark o_px-md o_py-lg" align="center"
            ...
            <div class="o_col-6s o_sans o_text-xs o_text-dark_light"
                ...
                <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">©2020 Лингвакит - Онлайн школа иностранных
                    языков</p>
            </div>
