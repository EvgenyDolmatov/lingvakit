    ...
    <tr>
        <td class="o_bg-white o_px-md o_pt" align="center"
            ...
            <h3 class="o_heading o_text-dark"
                style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 24px;line-height: 31px;">Новый вопрос с сайта</h3>
        </td>
    </tr>
    </tbody>
</table>
    ...
    <tr>
        <td class="o_bg-white o_px-md o_pt" align="center"
            ...
            <p class="o_heading o_text-dark"
               style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 14px;line-height: 31px;">Имя: {{$feedback->name}}</p>
            <p class="o_heading o_text-dark"
               style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 14px;line-height: 31px;">E-mail: {{$feedback->email}}</p>
            <p class="o_heading o_text-dark"
               style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;color: #242b3d;font-size: 14px;line-height: 31px;">Сообщение: {{$feedback->message}}</p>
        </td>
    </tr>
    </tbody>
</table>
