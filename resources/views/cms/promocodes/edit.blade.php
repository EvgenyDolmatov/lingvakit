...
@section('title', __("cms-pages.edit-promo-code"))
...
@endsection
@section('content')
    <form class="form-horizontal" method="POST" action="{{ route('promocodes.update', $promocode->id) }}">
        @csrf @method('PUT')
                        ...
                        <div class="form-group row d-flex align-items-center mb-5">
                            ...
                            <div class="col-lg-9">
                                <input type="text" name="code" class="form-control"
                                       placeholder="{{ __("cms-pages.promo-code") }}" value="{{$promocode->code}}">
                                @error('code')
                        ...
                        <div class="form-group row d-flex align-items-center mb-5">
                            ...
                            <div class="col-lg-9">
                                <textarea name="description" class="form-control" rows="3"
                                          placeholder="{{ __("cms-pages.description") }}">{{$promocode->description}}</textarea>
                                @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="styled-radio">
                                                <input type="radio" name="type" id="percent"
                                                       value="percent"
                                                       @if($promocode->type==='percent') checked @endif>
                                        ...
                                        <div class="mb-3">
                                            <div class="styled-radio">
                                                <input type="radio" name="type" id="amount"
                                                       value="amount"
                                                       @if($promocode->type==='amount') checked @endif>
                        ...
                        <div class="form-group row align-items-center mb-5 ">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <span id="discount-sign" class="input-group-addon addon-primary">
                                        @if($promocode->type==='amount') ₽ @else % @endif
                                    </span>
                                    <input type="number" name="discount" class="form-control"
                                           placeholder="{{ __("cms-pages.discount") }}"
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="expiration_date"
                                               class="form-control" id="date" value="{{$promocode->expiration_date}}">
