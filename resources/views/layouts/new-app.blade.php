...
<head>
    ...
    <!-- stylesheets -->
    <link rel="stylesheet" media="screen" href="{{ asset('assets/promo-site/js/bootstrap/bootstrap.min.css')}}" type="text/css" />
    ...
    <link rel="stylesheet" media="screen" href="{{ asset('assets/promo-site/css/responsive-leyouts.css')}}" type="text/css" />
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/promo-site/css/Simple-Line-Icons-Webfont/simple-line-icons.css')}}" media="screen" />
    <link rel="stylesheet" href="{{ asset('assets/promo-site/css/et-line-font/et-line-font.css')}}">
    <link href="{{ asset('assets/promo-site/js/animations/css/animations.min.css')}}" rel="stylesheet" type="text/css" media="all" />
